...
@Getter
@Setter
public class ProcessingEventDispatcher implements IProcessingEventDispatcher {
    ...
    public ProcessingEventDispatcher(RabbitTemplate rabbitTemplate) {
    ...
    public void sendProcessingRequest(String docId, String filename) {
        ...
        log.info("[ProcessingEventDispatcher.sendProcessingRequest] Sending processing request: {}", message);
        rabbitTemplate.convertAndSend(exchangeName, routingKey, message);
        log.info("[ProcessingEventDispatcher.sendProcessingRequest] Request sent to exchange '{}' with routing key '{}'", exchangeName, routingKey);
    }
}